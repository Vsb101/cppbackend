...
/**
 * @file player_tokens.h
 * @brief Управление токенами игроков
 */
...
/**
 * @brief Менеджер токенов игроков
 */
class PlayerTokens {
 public:
 ...
 private:
    std::unordered_map<Token, std::weak_ptr<Player>, TokenHasher> token_to_player_;
