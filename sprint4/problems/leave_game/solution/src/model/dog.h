...
public:
    ...
    void SetJoinTime(double time) { join_time_ = time; }
    [[nodiscard]] double GetJoinTime() const { return join_time_; }

    void StartInactivity(double time) { inactivity_start_time_ = time; }
    void StopInactivity() { inactivity_start_time_ = boost::none; }
    [[nodiscard]] bool IsInactive() const { return inactivity_start_time_.is_initialized(); }
    [[nodiscard]] double GetInactivityStartTime() const { return *inactivity_start_time_; }
...
private:
    ...
    boost::optional<double> inactivity_start_time_;
};
